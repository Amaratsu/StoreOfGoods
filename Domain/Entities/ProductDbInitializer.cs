...
namespace Domain.Entities
{
    public class ProductDbInitializer : DropCreateDatabaseAlways<EfDbContext>
    {
        protected override void Seed(EfDbContext db)
        {
            ...
            db.Products.Add(new Product
            {
                Name = "Samsung Galaxy S7 Edge 32GB Black Onyx [G935F]",
                Description =
            ...
            db.Products.Add(new Product
            {
                Name = "iPhone 5s 16GB Space Gray",
                Description =
            ...
            db.Products.Add(new Product
            {
                Name = "Logitech G403 Prodigy [910-004824]",
                Description =
